...
try {
    ...
    $sql = "
        ...
        GROUP BY da.codigo_cuenta, cc.nombre
        ORDER BY da.codigo_cuenta
    ";
    ...
    $libro_mayor = array_map(fn($row) => array_map('utf8_encode', $row), $rows);

    json_response(["success" => true, "libro" => $libro_mayor]);
} catch (Throwable $e) {
