...
try {
    ...
    $sql = "
        ...
        WHERE cc.tipo IN ('activo', 'pasivo', 'patrimonio') AND ac.fecha BETWEEN $1 AND $2
    ...
    $balance_general = array_map(fn($row) => array_map('utf8_encode', $row), $rows);

    json_response(["success" => true, "libro" => $balance_general]);
} catch (Throwable $e) {
