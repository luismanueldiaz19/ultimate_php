...
LEFT JOIN public.design_tipo ON design_tipo.design_tipo_id = item_pre_orden.design_tipo_id
LEFT JOIN public.design_images_items ON design_images_items.design_tipo_id = item_pre_orden.design_tipo_id
WHERE p.estado_general NOT IN ('ENTREGADO', 'POR ENTREGAR') AND p.num_orden ~ '^ORD-[0-9]+$'
...
try {
    ...
    foreach ($ordenes as $item) {
        ...
        if ($designId !== null) {
            ...
            if ($item['design_images_items_id'] !== null) {
